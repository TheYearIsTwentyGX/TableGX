...
- [Global search column gating](global-search-filter.md) — TanStack ANDs getColumnCanGlobalFilter with accessorFn presence; searchableColumns wins over meta.searchable; query is deferred.
