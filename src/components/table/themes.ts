...
export const LIQUID_GLASS_THEME: TableClassNames = {
  container: 'bg-white/40 dark:bg-white/5 backdrop-blur-xl border border-white/40 dark:border-white/10 shadow-2xl rounded-3xl overflow-hidden',
  ...
  tabStrip: 'bg-white/20 dark:bg-white/5 backdrop-blur-md border-b border-white/30 dark:border-white/10 px-4 pt-3',
  ...
  filterPopover: 'bg-white/70 dark:bg-gray-900/70 backdrop-blur-2xl border border-white/50 dark:border-white/10 shadow-2xl rounded-xl',
